module Casein
  module ConfigHelper
    ...
    # Filename of logo image. Ideally, it should be a transparent PNG around 140x30px | MaxHeight: 50px
    ...
    def casein_config_dashboard_url
      ...
      url_for :controller => :news, :action => :index
    end
